    ...
    TPGlobal.getTemplate = function (is12Hours, showSeconds) {
        ...
        '<div class="timepicker-picker">' +
          '<table class="table-condensed"' +
            ...
            '>' +
            '<tr>' +
              '<td><a href="#" class="btn" data-action="incrementHours"><span class="fa fa-chevron-up"></span></a></td>' +
              '<td class="separator"></td>' +
              '<td><a href="#" class="btn" data-action="incrementMinutes"><span class="fa fa-chevron-up"></span></a></td>' +
              (showSeconds ?
              '<td class="separator"></td>' +
              '<td><a href="#" class="btn" data-action="incrementSeconds"><span class="fa fa-chevron-up"></span></a></td>' : '') +
            ...
            '</tr>' +
            '<tr>' +
              '<td><a href="#" class="btn" data-action="decrementHours"><span class="fa fa-chevron-down"></span></a></td>' +
              '<td class="separator"></td>' +
              '<td><a href="#" class="btn" data-action="decrementMinutes"><span class="fa fa-chevron-down"></span></a></td>' +
              (showSeconds ?
              '<td class="separator"></td>' +
              '<td><a href="#" class="btn" data-action="decrementSeconds"><span class="fa fa-chevron-down"></span></a></td>' : '') +
              (is12Hours ? '<td class="separator"></td>' : '') +
            '</tr>' +
          '</table>' +
        '</div>' +
