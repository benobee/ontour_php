...
class MC_OAuth2Client extends OAuth2Client {
    ...
    public function __construct() {
        ...
        $base =  'http://evident-league-622.appspot.com/';   //your host
        $path = '/complete.php'; //the path on your host
            
        $client_id = '914557808963';   //client_id from creating app in MC (see README)
        $client_secret = '266f5db53cfac920fe39ccdc21ce174d'; //client_secret from creating app in MC  (see README)
